         ...
         (testing "real world robots.txt"
           (are [input output] (is (= (parse* (slurp (io/resource input))) output))
                "robots/alexa.com.txt"   [{"user-agent" "Mediapartners-Google*"}
                                          ...
                                          {"user-agent" "*"}
                                          {"disallow" "/"}]
                "robots/qq.com.txt"      [{"user-agent" "*"}
                                          {"disallow" ""}
                                          {"sitemap" "http://www.qq.com/sitemap_index.xml"}]
                "robots/amazon.com.txt"  [{"user-agent" "*"}
                                          ...
                                          {"sitemap" "http://www.amazon.com/sitemap_entity_index.xml.gz"}
                                          {"sitemap" "http://www.amazon.com/sitemaps.US_detail_page_sitemap_mobile_index.xml.gz"}
                                          {"sitemap" "http://www.amazon.com/sitemaps.US_detail_page_sitemap_desktop_index.xml.gz"}]
                "robots/eclipse.org.txt" [{"user-agent" "*"}
