...
(deftest test-parsing-of-input-with-just-a-user-agent-string
  ...
  (is (= { "msnbot" [] }           (parse "User-agent: msnbot # MSN, who uses dat.")))
  (is (= { "Oracle Secure Enterprise Search" [] }                (parse "User-agent: Oracle Secure Enterprise Search # must be some serious shit")))
